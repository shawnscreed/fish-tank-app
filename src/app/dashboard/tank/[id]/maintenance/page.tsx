    ...
    <ClientLayout>
      <div className="p-6">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-600 mb-2">Editable log of dosing or chemical treatments.</p>
              ...
              <tbody>
                {chemicals.map((chem) => (
                  <tr key={chem.id} className="hover:bg-gray-50">
                    <td className="border px-3 py-2 whitespace-nowrap">{chem.chemical_name}</td>
                    <td className="border px-3 py-2 whitespace-nowrap">{new Date(chem.added_at).toLocaleDateString()}</td>
