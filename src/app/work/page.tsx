...
import Link from "next/link"; // ⬅️ Add this at the top
...
const fetchWorkEntries = async () => {
  ...
  if (res.ok) {
    ...
    console.log("Fetched work entries:", data); // 👈 Add this
    setWorkEntries(data);
  } else {
...
{workEntries.map((entry) => (
  <li key={entry.id} className="mb-2">
    <div className="flex items-center justify-between">
      <Link href={`/work/${entry.id}`} className="text-blue-600 hover:underline">
