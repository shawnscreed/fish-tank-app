      ...
      <table className="w-full table-auto border-collapse border border-gray-300 rounded shadow-sm text-sm">
        ...
        <tbody>
          {fishList.map((fish) => (
            <tr key={fish.id}>
              ...
              <td className="border px-2 py-1">
                <button onClick={() => handleSave(fish.id!)} className="bg-blue-600 text-white px-2 py-1 rounded mr-1">
                  Save
                </button>
                <button onClick={() => handleDelete(fish.id!)} className="bg-red-600 text-white px-2 py-1 rounded">
                  Delete
                </button>
              </td>
            </tr>
          ...
          <tr>
            ...
            <td className="border px-2 py-1">
              <button onClick={() => handleSave("new")} className="bg-green-600 text-white px-3 py-1 rounded">
                Add
              </button>
            </td>
          </tr>
